...
var toastInit = function toastInit() {
  ...
  var liveToastErrorBtn = document.getElementById('liveToastErrorBtn');
  ...
  } else  if (liveToastErrorBtn) {
    var liveToastError = new window.bootstrap.Toast(document.getElementById('liveToastError'));
    liveToastErrorBtn.addEventListener('click', function () {
      liveToastError && liveToastError.show();
    });
  }
};
/* -------------------------------------------------------------------------- */
