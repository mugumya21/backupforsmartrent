...
<div class="modal-body p-0">
        <div class="bg-light rounded-top-lg py-2 ps-3 pe-6">
          <h4 class="" id="staticBackdropLabel">Create Base Currency</h4>
        
        </div>
<div class="p-3" style="margin-top:10px">
     
  {{ html()->form('POST')->route('admin.basecurrency.submit')->class('row g-3 needs-validation')->id('modal-form-submit')->novalidate()->open() }}
