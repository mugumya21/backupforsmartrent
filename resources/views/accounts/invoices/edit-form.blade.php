...
{{ html()->hidden('tenant_unit_id')->value($invoice->tenant_unit_id)->class('form-control form-control-sm')->id('tenantunit') }}
...
<div class="col-md-4">
  ...
  <div class="col-md-12">
    ...
    <select name="unit_id" class="form-select js-choice choices" required id="units" size="1" data-trigger data-options='{"removeItemButton":true,"placeholder":true}'>
      <option value="{{$invoice->unit_id}}" selected>{{$invoice->unit->name}}</option>
    </select>
  ...
  <div class="col-md-12">
    ...
    {{ html()->text('')->placeholder('Tenant')->value($invoice->client->clientname())->class('form-control form-control-sm')->isReadOnly()->id('client') }}

    {{ html()->hidden('tenant_id')->value($invoice->tenant_id)->class('form-control form-control-sm')->isReadOnly()->id('client_id') }}
  ...
  <div class="col-md-12">
    ...
    {{ html()->textarea('address')->value($invoice->address)->class('form-control form-control-sm')->id('address_id')->rows('3') }}
  </div>
...
<div class="col-md-4 text-center">
  ...
  <div class="col-md-4">
    <div class="col-md-12">
      ...
      {{ html()->select('account_id')->options($accounts->pluck('name','id'))->value($invoice->account_id)->required()->placeholder('Select an Option')->class('form-select form-select-sm js-choice')->id('currencyid') }}
    </div>
