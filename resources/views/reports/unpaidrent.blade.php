...
<div class="card mb-3">
  ...
  <div class="card-header bg-light">
    <div class="row flex-between-end">
      <div class="col-auto align-self-center">
        <h5 class="mb-0" data-anchor="data-anchor">UnPaid Rent Report<a class="anchorjs-link " aria-label="Anchor" data-anchorjs-icon="#" href="#example" style="padding-left: 0.375em;"></a></h5>
      </div>
 ...
 {{ html()->form('get')->route('reports.unpaidrent')->class('nobottompadding')->id('form-submit')->novalidate()->open() }}
...
{{ html()->select('currency_id')->options($currencies->pluck('name','id'))->value($search->currency_id)->class('form-select form-select-sm trigers')->placeholder('') }}
                ...
                <div class="row g-2 mt-2">
                  <div class="col-sm-6">
                    ...
                    <a class="btn btn-secondary me-1 mb-1 fullwidth filterbutton" href="{{route('reports.unpaidrent')}}" aria-expanded="false"> Reset </a>
...
{{ html()->form()->close() }}
  ...
  <div class="card-body text-justify">
    @include('reports.unpaidrent_table',['units'=>$units])
  </div>
