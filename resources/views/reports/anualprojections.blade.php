...
<div class="card mb-3">
  ...
  {{ html()->form('get')->route('reports.anualprojections')->class('')->id('form-submit')->novalidate()->open() }}

  <div class="card-header bg-light">
    <div class="row flex-between-end">
      <div class="col-auto align-self-center">
        <h5 class="mb-0" data-anchor="data-anchor">Annual Projections Report</h5>
      </div>
...
@endif
  ...
  <select name="years" class="form-select js-choice choices isyearly" required id="schedule_id" placeholder="Select an Option">
...
<option value="{{ $year->format("Y") }}"> {{ $year->format("Y") }}</option>
  ...
  @include('reports.anualprojections_table',['monthsarray'=>$monthsarray])
