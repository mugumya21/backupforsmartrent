...
<div class="card mb-3">
  ...
  {{ html()->form('get')->route('reports.quaterlyprojections')->class('')->id('form-submit')->novalidate()->open() }}

  <div class="card-header bg-light">
    <div class="row flex-between-end">
      <div class="col-auto align-self-center">
        <h5 class="mb-0" data-anchor="data-anchor">Quaterly Projections Report</h5>
      </div>
...
<option value="Jantomar" @if($search->months == 'Jantomar') selected @endif> January - March</option>
<option value="AprtoJun"  @if($search->months == 'AprtoJun') selected @endif> April - June</option>
<option value="JulytoSec"  @if($search->months == 'JulytoSec') selected @endif> July - September</option>
<option value="OcttoDec"  @if($search->months == 'OcttoDec') selected @endif> October - December</option>
  ...
  @include('reports.quaterlyprojections_table',['monthsarray'=>$monthsarray])
