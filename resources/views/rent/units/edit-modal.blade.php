...
<div class="modal-body p-0">
        <div class="bg-light rounded-top-lg py-2 ps-3 pe-6">
          <h4 class="" id="staticBackdropLabel">Edit a Unit</h4>
...
@if( $unit->id > 0 )
 ...
 {{ html()->hidden('property_id')->value($unit->property_id)->placeholder('Unit Number')->class('form-control form-control-sm') }}
